class OurTimeLeft {
  List<String> timeLeft(DateTime due) {
    ...
    if (_daysUntil > 0) {
      ...
      retVal[0] = _hoursUntil.toString() + " hours\n" + _minUntil.toString() + " mins\n" + _secUntil.toString() + " secs";
    } else if (_minUntil > 0) {
    ...
    int _secUntilReveal = _timeUntilReveal.inSeconds - (_daysUntilReveal * 24 * 60 * 60) - (_hoursUntilReveal * 60 * 60) - (_minUntilReveal * 60);
